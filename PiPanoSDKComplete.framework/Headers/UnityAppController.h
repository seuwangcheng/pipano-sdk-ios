...
//for iOS SDK Encapsulation 
- (void)willStartWithViewController:(UIViewController*)controller;
@property (nonatomic, strong) UINavigationController *defaultNavigationController;
- (void)setMainViewController: (UIViewController*)mainViewController mainViewNavigationCtler:(UINavigationController*)mainViewNavigationCtler;
